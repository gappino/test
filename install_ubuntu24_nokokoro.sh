...
# ===========================================
# VideoMaker Free V2 - Ubuntu 24 Installation Script (No Kokoro)
# ===========================================
# This script does NOT install Kokoro TTS

set -e  # Exit on any error

echo "==========================================="
echo "VideoMaker Free V2 - Ubuntu 24 Setup (No Kokoro)"
echo "==========================================="
...
if [[ $EUID -ne 0 ]]; then
   ...
   print_warning "Please run: sudo bash install_ubuntu24_nokokoro.sh"
   exit 1
fi
...
# NO KOKORO INSTALLATION - We use piper-tts instead
print_header "TTS System Setup..."
print_status "Using piper-tts (already installed from requirements.txt)"
print_status "Kokoro TTS is not needed - skipping installation"
