...
# ===========================================
# VideoMaker Free V2 - Ubuntu 24 Installation Script (Root Version)
# ===========================================
# This script is specifically designed to run as root on Ubuntu 24 servers

set -e  # Exit on any error

echo "==========================================="
echo "VideoMaker Free V2 - Ubuntu 24 Setup (Root)"
echo "==========================================="
...
if [[ $EUID -ne 0 ]]; then
   ...
   print_warning "Please run: sudo bash install_ubuntu24_root.sh"
   exit 1
fi
