...
# ===========================================
# VideoMaker Free V2 - Ubuntu 24 Installation Script (Fixed)
# ===========================================
# This script uses Ubuntu 24 default Python (3.12)

set -e  # Exit on any error

echo "==========================================="
echo "VideoMaker Free V2 - Ubuntu 24 Setup (Fixed)"
echo "==========================================="
...
if [[ $EUID -ne 0 ]]; then
   ...
   print_warning "Please run: sudo bash install_ubuntu24_fixed.sh"
   exit 1
fi
