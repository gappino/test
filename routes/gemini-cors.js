...
// Gemini API with proper CORS and headers for localhost
...
router.post('/generate-script', async (req, res) => {
    try {
        console.log('🤖 Calling Gemini API with CORS for script generation...');
...
router.post('/generate-image-prompt', async (req, res) => {
    try {
        ...
        console.log('🤖 Calling Gemini API with CORS for image prompt generation...');
...
router.post('/generate-niches', async (req, res) => {
    try {
        ...
        console.log('🤖 Calling Gemini API with CORS for niche generation...');
...
router.post('/generate-content', async (req, res) => {
    try {
        ...
        console.log('🤖 Calling Gemini API with CORS for content generation...');
